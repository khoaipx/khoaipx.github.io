      ...
      <div className="flex flex-col items-center justify-center md:flex-row">
        ...
        <div className="ml-0 md:ml-16">
          ...
          <h1 className="text-2xl font-normal leading-10">
            ...
            with over 8 years of experience, including more than 3 years of managing a high-performing team. I successfully built 
            a data science team from the ground up, which currently has 13 members and peaked at 18 members.
